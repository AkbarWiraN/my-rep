// scanner-updated.js - Silent Endpoint & Secrets Scanner (bookmarklet) - UPDATED
(async function(){
  // UI
  ...
  <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:8px">
    <strong style="font-size:14px">Silent Scanner (Optimized - Updated)</strong>
  ...
  // config
  const MAX_DEPTH = 3;
  const CONCURRENCY = 6; // limited parallelism
  ...
  panel.querySelector('#export-txt').onclick = ()=>{
    ...
    const a = document.createElement('a'); a.href = url; a.download = 'endpoints-optimized-updated.txt'; document.body.appendChild(a); a.click(); a.remove(); URL.revokeObjectURL(url);
  };
